# Cultivating Local Yokals Society [![Build Status](https://ci.blackieops.com/buildStatus/icon?job=localyokals-deploy)](https://ci.blackieops.com/job/localyokals-deploy/)
